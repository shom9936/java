...
class Santafe extends Suv{
	...
	public void run() { // 메소드 오버라이딩. (재정의 메소드)
	...
	public void speedPrint() {
		...
		run(); // 자식메소드 호출
		System.out.println("Santafe 속도 : " + this.speed); // 자식필드
		
	}
	
	// 부모클래스에서 상속받은 멤머필드의 이름과 자식클래스에서 만든 멤버필드의 이름이 같을 경우,
